...
public:
	...
	float GetLimbAV(int value) { return CdeclCall<double>(0x582B30, this, value, 0); }
};
...
public:
	...
	TESTopicInfo* GetTopicInfo(Actor* source, Actor* target) { return ThisCall<TESTopicInfo*>(0x565910, this, source, target); }
};
...
public:
	...
	Script* GetScript(int scriptType) { return ThisCall<Script*>(0x5669E0, this, scriptType); }
...
public:
	...
	bool			Run(TESObjectREFR* owner, void* xLocals, TESObjectREFR* container, bool isPartial) { return ThisCall<bool>(0x518C40, this, owner, xLocals, container, isPartial); }
};
...
public:
	...
	static TESPackage* Create(PackageType type) { return CdeclCall<TESPackage*>(0x5A9B40, type); }
};
