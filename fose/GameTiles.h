...
public:
	...
	static Tile*	GetMenuTile(UInt32 menuId) { return CdeclCall<Tile*>(0xBEAF00, menuId); }
	static void		RegisterTrait(const char* name, int id) { CdeclCall<void>(0xBEBCB0, name, id); }
